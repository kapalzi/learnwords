...
class FillDb {
   ...
   private static func loadWordsFromFiles() {
    ...
    LanguageSet.addNewLanguageSet(name: "German from English", depiction:"1000 most popular words.", code: "germanenglishtop1000", isUnlocked: true, identifier:"de",isUserMade: false, learningLanguage: "de", knownLanguage: "en", learningLanguageName: "German", knownLanguageName: "English", context: context)
        ...
        LanguageSet.addNewLanguageSet(name: "German from Polish", depiction:"100 most popular words.", code: "germanpolishtop1000", isUnlocked: true, identifier:"de",isUserMade: false, learningLanguage: "de", knownLanguage: "pl", learningLanguageName: "German", knownLanguageName: "Polish", context: context)
        LanguageSet.addNewLanguageSet(name: "Polish from German", depiction:"100 most popular words.", code: "polishgermantop1000", isUnlocked: true, identifier:"pl",isUserMade: false, learningLanguage: "pl", knownLanguage: "de", learningLanguageName: "Polish", knownLanguageName: "German", context: context)
